...
class ColumnDefinition
{
    ...
    public function toSql(): string
    {
        ...
        // Add default
        if (null !== $this->mtColumn->columnDefault) {
            $sql .= " DEFAULT '".addslashes($this->mtColumn->columnDefault)."'";
        }

        // Add auto increment
        if ('auto_increment' === $this->mtColumn->extra) {
            $sql .= ' AUTO_INCREMENT';
        }
